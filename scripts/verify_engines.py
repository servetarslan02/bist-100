...
print(f"  • Mevcut Seans Fazı: {msm.current_phase()}")
print(f"  • Sürekli Müzayede İşlem Saati Mi?: {msm.is_trading_hours()}")
print(f"  • Bir Sonraki Faza Kalan Süre: {msm.seconds_until_next_phase():.0f} saniye")
...
print(f"  • Hacim/Fiyat Anomali Skoru: {spec_res.anomaly_score:.2f}")
print(f"  • Kanıt Konsensüsü: {spec_res.evidence_consensus:.2f}")
...
print(f"  • Sonraki Seans Fazı: {status.next_phase}")
print(f"  • Rapor Üretimi Durumu: {'HAZIR' if status.daily_report_generated else 'BEKLİYOR'}")

print("\n=========================================================")
print("SONUÇ: 4 KURUMSAL MOTORUN TAMAMI %100 AKTİF VE ÇALIŞIYOR!")
print("=========================================================")
