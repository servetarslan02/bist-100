...
class HistoricalFundamentalProvider:
    ...
    def fetch_historical_fundamentals(
        ...
        try:
            ...
            logger.info("Historical fundamentals fetched", ticker=ticker, snapshots=len(snapshots))

        except Exception as e:
            logger.error("Historical fundamental fetch failed", ticker=ticker, error=str(e))
