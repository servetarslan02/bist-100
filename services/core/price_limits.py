...
class PriceLimitMonitor:
    ...
    def remove_corporate_action_ticker(self, ticker: str) -> Any:
    ...
    def set_post_circuit_breaker_limit(self, ticker: str) -> Any:
    ...
    def clear_post_circuit_breaker_limit(self, ticker: str) -> Any:
