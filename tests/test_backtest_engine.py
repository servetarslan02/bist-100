...
class TestDeflatedSharpe:
    ...
    def test_multiple_strategies_computed(self):
...
class TestWalkForwardEngine:
    ...
    def test_fold_creation(self):
        ...
        dates = [f"2020-01-{i:02d}" for i in range(1, 32)] + \
...
class TestBiasDetector:
    ...
    def test_label_feature_alignment_ok(self):
    ...
    def test_label_feature_alignment_fail(self):
    ...
    def test_fold_boundary_ok(self):
    ...
    def test_fold_boundary_fail(self):
...
class TestSurvivorshipBias:
    ...
    def test_universe_at_date(self):
    ...
    def test_empty_delistings(self):
...
class TestEdgeCases:
    ...
    def test_transaction_cost_negative_price(self):
