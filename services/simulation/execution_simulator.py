...
class Order:
    ...
    quantity: int
    price: float = 0.0          # Limit emir fiyatı
    stop_price: float = 0.0     # Stop fiyatı
...
class ExecutionSimulator:
    ...
    def execute_order(
        ...
        order.slippage = round(slippage * 100, 4)  # Yüzde olarak
    ...
    def _compute_slippage(
        ...
        if avg_volume > 0:
            ...
            # Katılım oranı arttıkça slippage artar
