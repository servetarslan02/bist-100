...
class TestRetryPolicyAsync:
    ...
    async def test_execute_non_retryable(self):
...
class TestBISTRetryPolicies:
    ...
    def test_get_yfinance_policy(self):
        """yfinance policy."""
...
class TestProviderManager:
    ...
    async def test_register_and_fetch(self):
        """Kayıt ve fetch."""
    ...
    async def test_failover(self):
        ...
        async def working_fetch(**kwargs):
            return {"price": 100}
