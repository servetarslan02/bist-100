...
class TestPiotroski:
    def test_strong_score(self):
        ...
        fin = {
            "net_income": 100, "operating_cf": 150, "roa": 0.12, "leverage": 0.3,
            "current_ratio": 2.0, "shares_outstanding": 1000, "gross_margin": 0.45,
            "asset_turnover": 1.5,
        }
        prev = {
            "roa": 0.08, "leverage": 0.5, "current_ratio": 1.5,
            "shares_outstanding": 1000, "gross_margin": 0.40, "asset_turnover": 1.2,
        }
    ...
    def test_weak_score(self):
        from services.factors.piotroski import calculate_f_score
        fin = {
            "net_income": -50, "operating_cf": -20, "roa": 0.02, "leverage": 0.8,
            "current_ratio": 0.8, "shares_outstanding": 1200, "gross_margin": 0.20,
            "asset_turnover": 0.5,
        }
        prev = {
            "roa": 0.05, "leverage": 0.6, "current_ratio": 1.2,
            "shares_outstanding": 1000, "gross_margin": 0.30, "asset_turnover": 0.8,
        }
        r = calculate_f_score(fin, prev)
        assert r["f_score"] <= 3
    ...
    def test_custom_weights(self):
        from services.factors.piotroski import calculate_f_score
        weights = {"net_income_positive": 2.0, "operating_cf_positive": 2.0,
                   "roa_increasing": 1.0, "cf_gt_ni": 1.0, "leverage_decreasing": 1.0,
                   "current_ratio_increasing": 1.0, "no_dilution": 1.0,
                   "gross_margin_increasing": 1.0, "asset_turnover_increasing": 1.0}
...
class TestBeneish:
    ...
    def test_manipulation_detected(self):
        from services.factors.beneish import calculate_m_score
        r = calculate_m_score({"dsri": 2.0, "gmi": 1.5, "aqi": 1.5, "sgi": 2.0,
                               "depi": 1.2, "sgai": 1.3, "lvgi": 1.5, "tata": 0.1})
    ...
    def test_with_real_data(self):
        from services.factors.beneish import calculate_m_score
        current = {"receivables": 500, "revenue": 2000, "gross_margin": 0.40,
                   "current_assets": 1000, "ppe": 500, "total_assets": 3000,
                   "depreciation": 100, "sga": 300, "total_debt": 1500,
                   "net_income": 200, "operating_cf": 300}
        previous = {"receivables": 400, "revenue": 1800, "gross_margin": 0.38,
                    "current_assets": 900, "ppe": 550, "total_assets": 2800,
                    "depreciation": 90, "sga": 280, "total_debt": 1400,
                    "net_income": 180, "operating_cf": 250}
...
class TestAltman:
    def test_safe_zone(self):
        ...
        fin = {"working_capital": 500, "total_assets": 2000, "retained_earnings": 800,
               "ebit": 400, "market_cap": 3000, "total_debt": 500, "revenue": 1500}
    ...
    def test_distress_zone(self):
        from services.factors.altman import calculate_z_score
        fin = {"working_capital": -500, "total_assets": 2000, "retained_earnings": -200,
               "ebit": 50, "market_cap": 200, "total_debt": 2000, "revenue": 300}
        r = calculate_z_score(fin, turkey_adjusted=False)
    ...
    def test_backward_compat(self):
        ...
        z = calculate_z_score_simple({"working_capital": 100, "total_assets": 1000,
                                      "retained_earnings": 200, "ebit": 150,
                                      "market_cap": 500, "total_debt": 300, "revenue": 800})
...
class TestFamaFrench:
    def test_factor_scores(self):
        ...
        stats = {"pb_ratio_median": 8, "pb_ratio_std": 3, "mom_6m_median": 5, "mom_6m_std": 10,
                 "roe_median": 12, "roe_std": 5, "market_cap_median": 2e9, "market_cap_std": 1e9,
                 "volatility_median": 20, "volatility_std": 10}
...
class TestBISTAnomalies:
    def test_anomalies(self):
        ...
        stock = {"dividend_yield": 5, "avg_volume": 5_000_000, "usdtry_beta": 0.8,
                 "sector_momentum": 3, "foreign_ownership": 20}
...
class TestIntegration:
    def test_full_pipeline(self):
        ...
        for i in range(5):
            fin = {
                "net_income": 100 + i * 50, "operating_cf": 150 + i * 30,
                "roa": 0.08 + i * 0.02, "leverage": 0.5 - i * 0.05,
                "current_ratio": 1.5 + i * 0.2, "shares_outstanding": 1000,
                "gross_margin": 0.35 + i * 0.03, "asset_turnover": 1.0 + i * 0.2,
                "working_capital": 200 + i * 100, "total_assets": 2000,
                "retained_earnings": 300 + i * 100, "ebit": 200 + i * 50,
                "market_cap": 1000 + i * 500, "total_debt": 500,
                "revenue": 1000 + i * 200,
            }
