...
def run_massive():
    print("--- 454 HISSE 5 YILLIK DEV OTONOM BACKTEST ---")
    engine = AlphaEngine()
    ...
    print(f"Basarili! Toplam indirilen hisse: {len(market_data)}")
    ...
    while current_idx < len(common_dates) - step_size:
        ...
        if len(X) == 0:
            print("Uyari: Yeterli egitim verisi yok, atlaniyor.")
        ...
        print(f"Secilen Hisseler: {selected_tickers}")
