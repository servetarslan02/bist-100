...
## 6. Orta Seviye Bulgular (0 adet)

| Boyut | Dosya | Satır | Kategori | Açıklama |
|---|---|---|---|---|

---
*Deep System Integrity Auditor v3.0 — JSON: `audit/full_spectrum_audit_20260829_192613.json`*
