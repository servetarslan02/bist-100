...
class TestProtobufSerialization:
    ...
    def test_market_tick_protobuf_roundtrip(self):
    ...
    def test_signal_protobuf_roundtrip(self):
    ...
    def test_portfolio_state_protobuf_roundtrip(self):
    ...
    def test_risk_metrics_protobuf_roundtrip(self):
...
class TestGRPCServicers:
    ...
    def test_market_servicer_get_tick(self):
    ...
    def test_signal_servicer_get_recent_signals(self):
    ...
    def test_risk_servicer_get_risk(self):
...
class TestGRPCClientConfiguration:
    ...
    def test_base_client_host_parsing_and_deadline(self):
    ...
    def test_correlation_metadata_helper(self):
