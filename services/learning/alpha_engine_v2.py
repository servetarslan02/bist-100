...
# ═════════════════════════════════════════════════════════════════════════
def sim_dual_momentum(top_n=5, mom_type="126", breadth_filter=0.35, use_repo=True):
...
# ═════════════════════════════════════════════════════════════════════════
def sim_breakout(top_n=5, vol_mult=1.3, use_repo=True):
...
# ═════════════════════════════════════════════════════════════════════════
def sim_rsi_pullback(top_n=5, rsi_entry=40, rsi_exit=65, use_repo=True):
...
for yr in years:
    ...
    row = f"{yr:<6}"
    for s_key in ["1. B&H Esit Agirlik (Benchmark)", "2. Dual Momentum Top 3 + PPF", "3. Dual Momentum Top 5 + PPF", "6. Donchian 20d Breakout + Hacim", "7. Trend + RSI Pullback Swing", "9. SUPER ENSEMBLE (Mom3+Break+Swing)"]:
