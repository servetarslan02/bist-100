...
def test_data_quality():
    ...
    print(f"ACTUAL: close={result.get('close')}, volume={result.get('volume')}, some_other_field={result.get('some_other_field')}")
...
def test_canonical_scoring():
    ...
    class FakeMLModel:
        def predict(self, X): raise ValueError('ML Failed')
