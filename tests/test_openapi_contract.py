...
class TestOpenAPIContract:
    ...
    def test_openapi_schema_accessible(self, client) -> Any:
    ...
    def test_all_paths_have_methods(self, client) -> Any:
    ...
    def test_all_operations_have_responses(self, client) -> Any:
    ...
    def test_all_operations_have_operation_id(self, client) -> Any:
    ...
    def test_health_endpoint(self, client) -> Any:
    ...
    def test_docs_endpoint(self, client) -> Any:
...
class TestAPIEndpointCoverage:
    ...
    def test_portfolio_routes(self, client) -> Any:
        """Otomatik eklendi."""
        resp = client.get("/api/v1/portfolio/")
        assert resp.status_code in (200, 401, 403, 404)

    def test_risk_routes(self, client) -> Any:
        """Otomatik eklendi."""
        resp = client.get("/api/v1/risk/portfolio")
        assert resp.status_code in (200, 401, 403, 404)

    def test_market_routes(self, client) -> Any:
        """Otomatik eklendi."""
