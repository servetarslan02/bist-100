...
def create_covered_call(spot: float, call_strike: float, call_premium: float, shares: int = 100) -> dict:
...
def create_protective_put(spot: float, put_strike: float, put_premium: float, shares: int = 100) -> dict:
