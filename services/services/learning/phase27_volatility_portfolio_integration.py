...
def calc_metrics(ret_series, exposure_series, name, tc_per_trade=0.002):
    ...
    return {
        "Name": name,
        "TotRet": tot_ret, "CAGR": cagr, "Sharpe": sharpe, "Sortino": sortino,
        "MaxDD": max_dd, "ProfitFactor": pf, "WinRate": win_rate,
        "Exposure": exposure, "Blocks": block_sharpes, "Series": net_ret
    }
